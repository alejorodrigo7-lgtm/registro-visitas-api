          ...
          <ScrollView style={styles.modalContent}>
            {servicioDetalle && (
              <>
                ...
                {servicioDetalle.origen === 'gestion' && (
                  <View style={styles.gestionBadge}>
                    <Text style={styles.gestionBadgeText}>Revisado por Gestión</Text>
                  </View>
                )}
                ...
                <View style={styles.detalleSeccion}>
                  ...
                  {servicioDetalle.segundaObservacion && (
                    <View style={[styles.detalleCampo, styles.segundaObsBox]}>
                      <Text style={styles.segundaObsLabel}>Segunda Observación (Gestión)</Text>
                      <Text style={styles.segundaObsValor}>{servicioDetalle.segundaObservacion}</Text>
                    </View>
                  )}
                ...
                <View style={styles.detalleSeccion}>
                  ...
                  {servicioDetalle.telefonoContacto && (
                    <View style={styles.detalleCampo}>
                      <Text style={styles.detalleCampoLabel}>Teléfono de Contacto</Text>
                      <Text style={styles.detalleCampoValor}>{servicioDetalle.telefonoContacto}</Text>
                    </View>
                  )}

                  {servicioDetalle.tipoContacto && (
                    <View style={styles.detalleCampo}>
                      <Text style={styles.detalleCampoLabel}>Tipo de Contacto</Text>
                      <Text style={styles.detalleCampoValor}>{servicioDetalle.tipoContacto}</Text>
                    </View>
                  )}
